...
- **Template**: `planning/templates/adr-template.md`
- **Global ADRs**: `docs/adr/`
- **Feature ADRs**: `planning/features/NNN-slug/adr/`
- **ADR Process**: `docs/adr/000-adr-process.md`
- **Full Workflow**: `.claude/commands/adr.md`
...
- **When**: User is in a feature directory (`planning/features/NNN-slug/`)
- **Location**: `planning/features/NNN-slug/adr/NNN-decision-title.md`
...
2. **Determine scope**:
   - In `planning/features/NNN-slug/` → Feature-specific ADR
...
1. **Read template** from `planning/templates/adr-template.md`
...
- Complete workflow details: `.claude/commands/adr.md`
