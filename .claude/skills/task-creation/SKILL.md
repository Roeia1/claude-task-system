...
1. **Read template** from `execution/templates/TASK-TEMPLATE.md`
...
1. **Determine next task ID** from `execution/TASK-LIST.md`
2. **Create task directory**: `execution/tasks/NNN/`
