...
- **Template**: `planning/templates/feature-template.md`
- **Output**: `planning/features/NNN-slug/feature.md`
- **Full Workflow**: `.claude/commands/define-feature.md`

## Process

1. **Parse feature description** from user input
2. **Determine next feature ID** by listing existing features in `planning/features/` and incrementing
3. **Generate feature slug** (kebab-case from description)
4. **Create feature directory**: `planning/features/NNN-slug/`
5. **Read template** from `planning/templates/feature-template.md`
...
- Complete workflow details: `.claude/commands/define-feature.md`
- Feature template structure: `planning/templates/feature-template.md`
