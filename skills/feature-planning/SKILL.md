...
- **Full Workflow**: Plugin's `commands/plan-feature.md`
...
3. **Read template** from plugin's templates/planning/plan-template.md
...
- Complete workflow details: Plugin's `commands/plan-feature.md`
