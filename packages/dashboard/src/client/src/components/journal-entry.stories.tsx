...
const JOURNAL_PRESETS: JournalPresetOption[] = [
	"session",
	"blocker",
	"resolution",
];
				...
				<div className="space-y-3">
					...
					<JournalEntryItem
						entry={createMockJournal("blocker", {
							...
							content:
								"Need clarification on the data model before proceeding.",
...
const Playground: Story = {
	...
	play: async ({ canvasElement, args }) => {
		...
		const entryTitles = canvas.getAllByText(
			`${presetToLabel(args.preset)}: Custom entry`,
		);
