...
const epicPresetCounts: Record<EpicPreset, StoryCounts> = {
  ...
  'just-started': { ready: 5, inProgress: 0, blocked: 0, completed: 0, total: 5 },
  'in-progress': { ready: 1, inProgress: 4, blocked: 0, completed: 2, total: 7 },
  'has-blockers': { ready: 1, inProgress: 2, blocked: 2, completed: 1, total: 6 },
  'almost-done': { ready: 0, inProgress: 1, blocked: 0, completed: 7, total: 8 },
