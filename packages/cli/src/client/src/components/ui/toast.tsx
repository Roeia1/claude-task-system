...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root ref={ref} class={cn(toastVariants({ variant }), className)} {...props} />
  );
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} class={cn('text-sm font-semibold', className)} {...props} />
));
