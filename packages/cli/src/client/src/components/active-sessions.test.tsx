...
describe("ActiveSessions", () => {
	...
	describe("loading state", () => {
		it("shows skeleton while fetching sessions", () => {
			...
			expect(
				screen.getByTestId("active-sessions-skeleton"),
			).toBeInTheDocument();
		});
	});
	...
	describe("empty state (hidden)", () => {
		it("renders nothing when no running sessions exist", async () => {
			...
			await waitFor(() => {
				expect(
					screen.queryByTestId("active-sessions-skeleton"),
	...
	describe("populated state", () => {
		...
		it("renders output preview for sessions", async () => {
			...
			await waitFor(() => {
				expect(
					screen.getByText(BUILDING_COMPONENTS_PATTERN),
				).toBeInTheDocument();
				expect(
					screen.getByText(IMPLEMENTING_LOGIN_PATTERN),
				).toBeInTheDocument();
			});
		});
