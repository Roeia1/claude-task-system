...
- **If journal doesn't exist**: Read skill's `journal-creation.md` and follow creation process
...
- Check if journal exists at `task-system/tasks/{task_id}/journal.md`
- If not found AND task directory exists: Read skill's `journal-creation.md` and create journal
