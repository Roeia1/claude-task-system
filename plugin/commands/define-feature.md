...
/task-system:define-feature "real-time notification center"
/task-system:define-feature "advanced search with filters"
```
...
4. **Create directory structure**
   ...
   ├── plan.md       (created later by /task-system:plan-feature)
   ├── tasks.md      (created later by /task-system:generate-tasks)
   └── adr/          (created as needed by /task-system:adr)
   ```
...
10. **Report completion**
    ...
    - Run /task-system:plan-feature to create technical plan
    ```
...
Implementation details belong in plan.md (created with `/task-system:plan-feature`).
...
Usage: /task-system:define-feature "feature description"

Example: /task-system:define-feature "user authentication with OAuth"
```
...
```bash
/task-system:define-feature "export data to CSV"
```
...
```bash
/task-system:define-feature "multi-tenant user management with role-based permissions"
```
...
**Next Command**: After defining a feature, use `/task-system:plan-feature` to create the technical plan.
