...
- **Full Workflow**: Plugin's `commands/parallel-finalize-task.md`
...
1. **Remove worktree-specific CLAUDE.md content**:
   ...
   - Remove section before original content marker
...
- Complete workflow details: Plugin's `commands/parallel-finalize-task.md`
