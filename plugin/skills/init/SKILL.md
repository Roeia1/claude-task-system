...
**Next steps:**
1. **Plan your work**: Use `/plan <goal>` to collaboratively plan and create stories
2. **Execute a story**: Use `/execute-story <story>` to start autonomous story execution
