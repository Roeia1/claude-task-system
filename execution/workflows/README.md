...
All workflows reference common protocols from `execution/shared/`:

- **[PR Review Protocol](../shared/pr-review-protocol.md)** - Handling PR feedback
- **[Test Modification Protocol](../shared/test-modification-protocol.md)** - Rules for changing tests
- **[Journal Guidelines](../shared/journal-guidelines.md)** - Writing effective journal entries
- **[Completion Protocol](../shared/completion-protocol.md)** - Phase 8 completion steps
- **[Verification Checklist](../shared/verification-checklist.md)** - Phase 6-7 checks
- **[Phase Transition Rules](../shared/phase-transition-rules.md)** - Permission gates
...
When you run `/project:start-task [ID]`, the system:
...
- [TASK-LIST.md](../TASK-LIST.md) - All tasks and their status
- [PARALLEL-WORKFLOW-GUIDE.md](../PARALLEL-WORKFLOW-GUIDE.md) - Concurrent execution
- [templates/TASK-TEMPLATE.md](../templates/TASK-TEMPLATE.md) - Task file structure
